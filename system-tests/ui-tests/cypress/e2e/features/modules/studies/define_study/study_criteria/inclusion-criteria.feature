@REQ_ID:1074256
Feature: Studies - Study Inclusion Criteria

    Background: User is logged in and study has been selected
        Given The user is logged in   
        And A test study is selected

    Scenario: User must be able to navigate to the Inclusion Criteria page
    ...
    Scenario: User must be able to create the Inclusion Criteria from scratch
        Given The '/studies/Study_000001/selection_criteria/Inclusion%20Criteria' page is opened
    ...
    Scenario: User must be able to select Inclusion Criteria from other existing studies by study id
