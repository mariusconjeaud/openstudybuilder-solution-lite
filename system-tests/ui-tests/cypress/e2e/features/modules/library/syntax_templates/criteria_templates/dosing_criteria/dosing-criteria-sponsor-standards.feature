...
Feature: Library - Syntax Templates - Criteria - Dosing - Parent
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Dosing Criteria template without: Indication or Disorder, Criterion Category, Criterion Sub-Category
    Given The 'library/criteria_templates/Dosing/parent' page is opened
