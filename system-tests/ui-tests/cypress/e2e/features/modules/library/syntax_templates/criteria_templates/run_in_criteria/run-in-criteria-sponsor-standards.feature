...
Feature: Library - Syntax Templates - Criteria - Run-in - Parent
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Run-in Criteria template without: Indication or Disorder, Criterion Category, Criterion Sub-Category
    Given The 'library/criteria_templates/Run-in/parent' page is opened
