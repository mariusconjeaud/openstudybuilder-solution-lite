...
Feature: Library - Syntax Templates - Criteria - Exclusion - Parent
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Exclusion Criteria template without: Indication or Disorder, Criterion Category, Criterion Sub-Category
    Given The 'library/criteria_templates/Exclusion/parent' page is opened
