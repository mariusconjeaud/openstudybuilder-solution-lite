...
Feature: Library - Syntax Templates - Criteria - Withdrawal - Parent
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Withdrawal Criteria template without: Indication or Disorder, Criterion Category, Criterion Sub-Category
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
