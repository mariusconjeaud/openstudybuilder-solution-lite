@REQ_ID:1070684
Feature: Library - Withdrawal Criteria - Parent Templates

  As a user, I want to manage every Withdrawal Criteria template under the Syntax template Library
  Background: User must be logged in
    Given The user is logged in

  Scenario: User must be able to navigate to the Withdrawal Criteria template under the Syntax template Library
  ...
  Scenario: User must be able to add a new Withdrawal Criteria template in parent standards tab
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
    When The new criteria is added in the library
    Then The new Criteria is visible in the Criteria Templates Table

  Scenario: User must be able to add a new Withdrawal Criteria template with NA indexes in parent standards tab
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
  ...
  Scenario: User must be able to edit draft version of the Withdrawal Criteria template
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
  ...
  Scenario: User must not be able to create a new Withdrawal Criteria template without Template Text populated
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
    When The new Criteria template is added without template text
    Then The validation appears for Template Text field
    And The form is not closed

  Scenario: User must not be able to create a new Withdrawal Criteria template without Indication or Disorder populated
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
  ...
  Scenario: User must be able to verify valid syntax when adding a new Withdrawal Criteria template
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
  ...
  Scenario: User must be able to hide parameter from the Withdrawal Criteria template
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
    When The new template name is prepared with a parameters
    And The user hides the parameter in the next step
    Then The parameter is not visible in the text representation

  Scenario: User must be able to select parameter for the Withdrawal Criteria template
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
    When The new template name is prepared with a parameters
    And The user picks the parameter from the dropdown list
    Then The parameter value is visible in the text representation

  Scenario: User must be able to delete the drafted version of Withdrawal Criteria template in version below 1.0
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
    And The new criteria is added in the library
  ...
  Scenario: User must be able to approve the drafted version of Withdrawal Criteria template
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
    And The new criteria is added in the library
  ...
  Scenario: User must not be able to save the edited version of the draft Withdrawal Criteria template without filled in mandatory field 'Change description'
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
    And The new criteria is added in the library
    When The 'Edit' option is clicked from the three dot menu list
  ...
  Scenario: User must be able to add a new version for the Withdrawal Criteria template with a status as 'Final'
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
    And The criteria template exists with a status as 'Final'
  ...
  Scenario: User must be able to inactivate the Withdrawal Criteria template with a status as 'Final'
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
  ...
  Scenario: User must be able to reactivate the Withdrawal Criteria template with a status as 'Retired'
    Given The 'library/criteria_templates/Withdrawal/parent' page is opened
