...
from consumer_api.auth.dependencies import dummy_user
from consumer_api.auth.models import User
from consumer_api.shared.exceptions import ForbiddenException
