...
@router.get(
    "/codelists/{codelistuid}/names/versions",
    summary="Returns the version history of a specific CTCodelistName identified by 'codelistuid'.",
...
def get_versions(
    ...
    ct_codelist_name_service = CTCodelistNameService(user=current_user_id)
    return ct_codelist_name_service.get_version_history(codelist_uid=codelistuid)
...
@router.post(
    "/codelists/{codelistuid}/names/new-version",
...
def create(
    ...
    ct_codelist_name_service = CTCodelistNameService(user=current_user_id)
    return ct_codelist_name_service.create_new_version(codelist_uid=codelistuid)


@router.post(
    "/codelists/{codelistuid}/names/approve",
...
def approve(
    ...
    ct_codelist_name_service = CTCodelistNameService(user=current_user_id)
    return ct_codelist_name_service.approve(codelist_uid=codelistuid)
