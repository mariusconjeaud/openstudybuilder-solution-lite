...
class TopicCdDef(BaseModel):
    ...
    description: str = Field(None, title="description", description="Description")
    molecular_weight: float = Field(
        None, title="molecular_weight", description="Molecular Weight"
    )
    sas_display_format: str = Field(
        None, title="sas_display_format", description="SAS Display Format"
    )
    general_domain_class: str = Field(
        None, title="general_domain_class", description="General Domain Class"
    )
    sub_domain_class: str = Field(
        None, title="sub_domain_class", description="Sub Domain Class"
    )
    sub_domain_type: str = Field(
        None, title="sub_domain_type", description="Sub Domain Type"
    )
