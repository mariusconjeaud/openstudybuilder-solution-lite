...
class ObjectiveTemplate(ObjectiveTemplateNameUid):
    ...
    confirmatory_testing: Optional[bool] = Field(
    ...
    def from_objective_template_ar(
        ...
        return cls(
            ...
            editable_instance=objective_template_ar.editable_instance,
            ...
            confirmatory_testing=objective_template_ar.confirmatory_testing,
            indications=[
