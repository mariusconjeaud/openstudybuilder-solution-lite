...
class StudyVisitOGM(BaseModel, StudyVisitVO):
    ...
    note: Optional[str] = Field(
        None, title="Note", description="Note", source="note", nullable=True
    )
    ...
    timepoint: Optional[TimePoint] = Field(None, nullable=True)
    study_day: Optional[StudyDay] = Field(None, nullable=True)
    study_week: Optional[StudyWeek] = Field(None, nullable=True)
    study_duration_days: Optional[StudyDurationDays] = Field(None, nullable=True)
    study_duration_weeks: Optional[StudyDurationWeeks] = Field(None, nullable=True)
