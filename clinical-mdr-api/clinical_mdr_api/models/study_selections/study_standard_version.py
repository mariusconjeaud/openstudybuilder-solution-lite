...
class StudyStandardVersionOGM(BaseModel, StudyStandardVersionVO):
    ...
    uid: Annotated[str, Field(description="Uid of the StandardVersion", source="uid")]
    study_uid: Annotated[
        str, Field(description="Uid of the study", source="has_after.audit_trail.uid")
    ]

    study_status: Annotated[StudyStatus, Field(source="status")]
...
class StudyStandardVersion(BaseModel):
    ...
    ct_package: Annotated[
        CTPackage | None, Field(description="CtPackage", nullable=True)
    ]
    description: Annotated[
        str | None,
        Field(description="Description of the study standard version", nullable=True),
    ]
    automatically_created: Annotated[
        bool,
        Field(
    ...
    end_date: Annotated[
        datetime | None,
        Field(
            description="Study StandardVersion last modification date", nullable=True
        ),
    ] = None
