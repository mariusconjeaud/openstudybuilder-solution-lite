...
from clinical_mdr_api.domain.concepts.odms.vendor_element import OdmVendorElementAR
from clinical_mdr_api.domain.concepts.odms.vendor_namespace import OdmVendorNamespaceAR
...
class OdmVendorAttribute(ConceptModel):
    ...
    vendor_namespace: Optional[OdmVendorNamespaceSimpleModel]
    vendor_element: Optional[OdmVendorElementSimpleModel]
