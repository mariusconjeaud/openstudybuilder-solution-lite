...
def test_patch_activity_non_existent_sub_group1(api_client):
    data = {
...
def test_patch_activity_name_already_exists1(api_client):
    data = {
        "name": "name1",
        "name_sentence_case": "name1",
        "change_description": "Test change",
...
def test_delete_activations_non_final_activity_sub_group(api_client):
    response = api_client.delete(
        "/concepts/activities/activity-sub-groups/activity_subgroup_root2/activations"
    )
...
def test_post_activations_non_retired_activity_sub_group(api_client):
    response = api_client.post(
        "/concepts/activities/activity-sub-groups/activity_subgroup_root2/activations"
    )
