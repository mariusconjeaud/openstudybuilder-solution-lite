...
@pytest.fixture(scope="module")
def test_data():
    inject_and_clear_db("old.json.test.instance.multiple.brackets")
    ...
    drop_db("old.json.test.instance.multiple.brackets")


def test_name_generation_of_objective_with_0_values_for_both_template_parameters2(
    api_client,
):
    data = {
...
def test_name_generation_of_objective_with_1_template_parameter_term_0_template_parameter_terms2(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_2_template_parameters_terms_0_template_parameter_terms2(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_3_template_parameters_terms_0_template_parameter_terms2(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_0_template_parameter_terms_1_template_parameter_term2(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_1_template_parameter_term_1_template_parameter_term2(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_2_template_parameters_terms_1_template_parameter_term2(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_3_template_parameters_terms_1_template_parameter_term2(
    api_client,
):
    data = {
        "library_name": "Test library",
