...
@pytest.fixture(scope="module")
def test_data() -> Generator[None, Any, None]:
    inject_and_clear_db("old.json.test.instance.multiple")
    ...
    drop_db("old.json.test.instance.multiple")


def test_name_generation_of_objective_with_0_values_for_both_template_parameters(
    api_client,
):
    data = {
    ...
    assert res["template"] == {
        "name": "To investigate [Indication] [Intervention]",
        "name_plain": "To investigate [Indication] [Intervention]",
        "guidance_text": None,
...
def test_name_generation_of_objective_with_1_template_parameter_term_0_template_parameter_terms(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_2_template_parameters_terms_0_template_parameter_terms(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_3_template_parameters_terms_0_template_parameter_terms(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_0_template_parameter_terms_1_template_parameter_term(
    api_client,
):
    data = {
        "library_name": "Test library",
...
def test_name_generation_of_objective_with_1_template_parameter_term_1_template_parameter_term(
    api_client,
):
    data = {
        "library_name": "Test library",
    ...
    assert res["name"] == "To investigate [type 2 diabetes] [Metformin]"
    assert res["name_plain"] == "To investigate type 2 diabetes Metformin"
    assert res["end_date"] is None
    assert res["status"] == "Draft"
    assert res["study_count"] == 0
    assert res["version"] == "0.1"
...
def test_name_generation_of_objective_with_2_template_parameters_terms_1_template_parameter_term(
    api_client,
):
    data = {
        "library_name": "Test library",
    ...
    assert (
        res["name"]
        == "To investigate [type 2 diabetes and coronary heart disease] [Metformin]"
    )
    assert (
        res["name_plain"]
        == "To investigate type 2 diabetes and coronary heart disease Metformin"
...
def test_name_generation_of_objective_with_3_template_parameters_terms_1_template_parameter_term(
    api_client,
):
    data = {
        "library_name": "Test library",
    ...
    assert (
        res["name"]
        == "To investigate [type 2 diabetes, coronary heart disease and breathing problems] [Metformin]"
    )
    assert (
        res["name_plain"]
        == "To investigate type 2 diabetes, coronary heart disease and breathing problems Metformin"
