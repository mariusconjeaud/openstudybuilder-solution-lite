...
class DictionaryTermsSubstancesTest(api.APITest):
    TEST_DB_NAME = "dictionarycodelists.substances"
    ...
    SCENARIO_PATHS = [
        os.path.join(BASE_SCENARIO_PATH, "dictionary_terms_substances.json")
    ]
...
class DictionaryTermsSubstancesNegativeTest(api.APITest):
    ...
    SCENARIO_PATHS = [
        os.path.join(BASE_SCENARIO_PATH, "dictionary_terms_substances_negative.json")
    ]
