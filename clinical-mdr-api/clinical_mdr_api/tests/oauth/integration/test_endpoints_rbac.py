...
import clinical_mdr_api.oauth.dependencies
from clinical_mdr_api.oauth.dependencies import oidc_client
...
def test_endpoints_rbac_wrong_roles(
    ...
    monkeypatch.setattr(
        clinical_mdr_api.oauth.dependencies, "jwks_service", mock_jwks_service
    )
