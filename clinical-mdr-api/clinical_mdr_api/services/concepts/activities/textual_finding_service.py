    ...
    def _create_aggregate_root(
        ...
        return TextualFindingAR.from_input_values(
            ...
            concept_vo=TextualFindingVO.from_repository_values(
                ...
                max_text_length=concept_input.max_text_length,
                split_text_in_supp_qual=concept_input.split_text_in_supp_qual,
    ...
    def _edit_aggregate(
        ...
        item.edit_draft(
            ...
            concept_vo=TextualFindingVO.from_repository_values(
                ...
                max_text_length=concept_edit_input.max_text_length,
                split_text_in_supp_qual=concept_edit_input.split_text_in_supp_qual,
                activity_type="textual-findings",
            ),
