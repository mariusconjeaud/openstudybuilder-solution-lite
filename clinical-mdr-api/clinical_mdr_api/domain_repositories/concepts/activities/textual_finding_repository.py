...
from clinical_mdr_api.models.activities.textual_finding import TextualFinding


class TextualFindingRepository(ActivityInstanceRepository):
    root_class = TextualFindingRoot
    value_class = TextualFindingValue
    return_model = TextualFinding
    ...
    def _create_new_value_node(self, ar: _AggregateRootType) -> VersionValue:
        ...
        value_node.max_text_length = ar.concept_vo.max_text_length
        value_node.split_text_in_supp_qual = ar.concept_vo.split_text_in_supp_qual
        value_node.save()
    ...
    def _has_data_changed(self, ar: _AggregateRootType, value: VersionValue) -> bool:
        ...
        are_props_changed = (
            ...
            or ar.concept_vo.max_text_length != value.max_text_length
            or ar.concept_vo.split_text_in_supp_qual != value.split_text_in_supp_qual
        )

        are_rels_changed = ar.concept_vo.specimen_uid != self._get_uid_or_none(
            self._get_specimen(value)
        ) or ar.concept_vo.test_code_uid != self._get_uid_or_none(
            self._get_test_code(value)
        )
    ...
    def _create_aggregate_root_instance_from_cypher_result(
        ...
        return TextualFindingAR.from_repository_values(
    ...
    def _create_aggregate_root_instance_from_version_root_relationship_and_value(
        ...
        return TextualFindingAR.from_repository_values(
            ...
            concept_vo=TextualFindingVO.from_repository_values(
                ...
                max_text_length=value.max_text_length,
                split_text_in_supp_qual=value.split_text_in_supp_qual,
            ),
            library=LibraryVO.from_input_values_2(
    ...
    def _get_specimen(
        self, value: TextualFindingValue
