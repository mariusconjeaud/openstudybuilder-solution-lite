...
class LagTimeRepository(NumericValueWithUnitRepository):
    ...
    def _create_aggregate_root_instance_from_cypher_result(
        ...
        return self.aggregate_class.from_repository_values(
            ...
            simple_concept_vo=self.value_object_class.from_repository_values(
                ...
                sdtm_domain_uid=input_dict.get("sdtmDomainUid"),
            ),
    ...
    def specific_alias_clause(self) -> str:
        ...
        WITH *,
            ...
            head([(concept_value)-[:HAS_SDTM_DOMAIN]->(sdtm_domain:CTTermRoot) | sdtm_domain.uid]) AS sdtmDomainUid
        """
    ...
    def find_uid_by_value_unit_and_domain(
        ...
        cypher_query = f"""
            ...
            MATCH (ov)-[:HAS_SDTM_DOMAIN]->(termRoot:CTTermRoot {{uid: $sdtm_domain_uid}})
            RETURN or.uid
        """
