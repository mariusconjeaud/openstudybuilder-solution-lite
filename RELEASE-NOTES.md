# Release notes for OpenStudyBuilder (OSB)

This is the second commit (Version 0.2) of the OpenStudyBuilder (OSB) with the below improvements, bug fixes and features.
