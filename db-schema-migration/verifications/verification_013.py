...
from tests import test_migration_013
...
def test_ct_config_values():
    test_migration_013.test_ct_config_values(migration)


def test_indexes_and_constraints():
    test_migration_013.test_indexes_and_constraints(migration)


def test_migrate_visit_group_into_node():
    test_migration_013.test_migrate_visit_group_into_node(migration)
