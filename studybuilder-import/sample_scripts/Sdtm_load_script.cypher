...
MERGE (DomainRoot)-[r2:LATEST_DRAFT {change_description:'Initial version', start_date:datetime(), status:'Draft', user_initials:'ndsj', version:'0.1'}]->(DomainValue)
...
MERGE (DomainRoot)-[r2:LATEST_DRAFT {change_description:'Initial version', start_date:datetime(), status:'Draft', user_initials:'ndsj', version:'0.1'}]->(VariableRoot)
