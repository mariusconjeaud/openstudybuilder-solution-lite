...
from mdr_standards_import.scripts.wrapper.wrapper_bulk_import import wrapper_bulk_import
...
wrapper_bulk_import(
    get_user_initials(1), get_directory_name(2), get_skip_download_step(3)
)
