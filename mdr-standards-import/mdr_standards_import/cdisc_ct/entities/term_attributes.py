...
class TermAttributes(Attributes):
    def __init__(self, name_submission_value: str, preferred_term: str, definition: str, synonyms: Sequence[str]):
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and self.name_submission_value == other.name_submission_value
    ...
    def to_string(self):
        codelist_concept_ids = [
            codelist.concept_id for codelist in self.__codelists]
