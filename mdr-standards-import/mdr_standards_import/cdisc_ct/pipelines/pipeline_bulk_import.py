"""
This script serves as the entry point for the pipeline step to combine both import steps into a single pipeline without breaks.
...
from mdr_standards_import.cdisc_ct.wrapper.wrapper_bulk_import import wrapper_bulk_import
from mdr_standards_import.cdisc_ct.utils import get_directory_name, get_skip_download_step, get_user_initials


wrapper_bulk_import(get_user_initials(1), get_directory_name(2), get_skip_download_step(3))
