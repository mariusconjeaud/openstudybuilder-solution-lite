...
class TestTermSubmissionValueDifferentiator:
    ...
    def test__get_term_submission_value_pair__on_code2__ok(self):
        ...
        codelist1.add_attributes(CodelistAttributes(
            'Functional Assessment of Cancer Therapy/Gynecologic Oncology Group-Neurotoxicity Version 4 Questionnaire Test Name', 'FAC057TN', None, None, None, None), None)
        tsv1 = CodelistTermSubmissionValue(codelist1)
        tsv1.add_submission_value('A')

        codelist2 = Codelist('C150780')
        codelist2.add_attributes(CodelistAttributes(
            'Functional Assessment of Cancer Functional Assessment of Cancer Therapy/Gynecologic Oncology Group-Neurotoxicity Version 4 Questionnaire Test Code', 'FAC057TC', None, None, None, None), None)
        tsv2 = CodelistTermSubmissionValue(codelist2)
    ...
    def test__get_term_submission_value_pair__on_name__ok(self):
        ...
        codelist1.add_attributes(CodelistAttributes(
            'SEND Subject Characteristics Test Code', 'SBCCDSND', None, None, None, None), None)
        tsv1 = CodelistTermSubmissionValue(codelist1)
        tsv1.add_submission_value('SPLRLOC')

        codelist2 = Codelist('C89980')
        codelist2.add_attributes(CodelistAttributes(
            'SEND Subject Characteristics Test Name', 'SBCSND', None, None, None, None), None)
        tsv2 = CodelistTermSubmissionValue(codelist2)
