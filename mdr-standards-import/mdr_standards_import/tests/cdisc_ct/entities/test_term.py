...
class TestTerm:
    def test__add_submission_value__same_sv__one_value(self):
        ...
        codelist_concept_ids = [
            codelist.concept_id for codelist in term.get_term_submission_value('SV1').get_codelists()]
    ...
    def test__add_submission_value__different_svs__two_values(self):
        ...
        assert 'C1' in [
            codelist.concept_id for codelist in term.get_term_submission_value('SV1').get_codelists()]
        assert 'C2' in [
            codelist.concept_id for codelist in term.get_term_submission_value('SV2').get_codelists()]
    ...
    def test__add_attributes__same_attributes__consistent(self):
        # given
        term = Term('C123')
        attributes1 = TermAttributes(
            'nsv', 'preferred_term', 'definition', ['1', '2'])
        attributes2 = TermAttributes(
            'nsv', 'preferred_term', 'definition', ['2', '1']
        )
        codelist1 = Codelist('C1')
    ...
    def test__add_attributes__different_nsv__inconsistent(self):
        ...
        term = Term('C123')
        attributes1 = TermAttributes(
            'nsv1', 'preferred_term', 'definition', [])
        attributes2 = TermAttributes(
            'nsv2', 'preferred_term', 'definition', [])
    ...
    def test__add_attributes__different_pterm__inconsistent(self):
        ...
        term = Term('C123')
        attributes1 = TermAttributes(
            'nsv', 'preferred_term1', 'definition', [])
        attributes2 = TermAttributes(
            'nsv', 'preferred_term2', 'definition', [])
    ...
    def test__add_attributes__different_definition__inconsistent(self):
        ...
        term = Term('C123')
        attributes1 = TermAttributes(
            'nsv', 'preferred_term', 'definition1', [])
        attributes2 = TermAttributes(
            'nsv', 'preferred_term', 'definition2', [])
    ...
    def test__add_attributes__different_synonyms__inconsistent(self):
        ...
        term = Term('C123')
        attributes1 = TermAttributes(
            'nsv', 'preferred_term', 'definition', ['A', 'b'])
        attributes2 = TermAttributes(
            'nsv', 'preferred_term', 'definition', ['a', 'b'])
    ...
    def test__get_code_name_submission_value_pairs__two_pairs__ok(self):
        ...
        codelist1.add_attributes(CodelistAttributes(
    ...
    def test__get_code_name_submission_value_pairs__two_pairs__ok(self):
        ...
        codelist1.add_attributes(CodelistAttributes(
            'Morphology Test Code', 'MOTESTCD', None, None, None, None), None)
        term.add_submission_value('WIDTH', codelist1)

        codelist2 = Codelist('C114116')
        codelist2.add_attributes(CodelistAttributes(
            'Morphology Test Name', 'MOTEST', None, None, None, None), None)
        term.add_submission_value('Width', codelist2)

        codelist3 = Codelist('C95121')
        codelist3.add_attributes(CodelistAttributes(
            'Physical Properties Test Code', 'PHSPRPCD', None, None, None, None), None)
        term.add_submission_value('WIDTH', codelist3)

        codelist4 = Codelist('C95120')
        codelist4.add_attributes(CodelistAttributes(
            'Physical Properties Test Name', 'PHSPRP', None, None, None, None), None)
    ...
    def test__get_code_name_submission_value_pairs__two_pairs_plus_one__ok(self):
        ...
        codelist5.add_attributes(CodelistAttributes(
            'Something', 'X', None, None, None, None), None)
        term.add_submission_value('OTHER', codelist5)

        codelist6 = Codelist('C99999')
        codelist6.add_attributes(CodelistAttributes(
            'Something Else', 'X', None, None, None, None), None)
    ...
    def test__get_code_name_submission_value_pairs__two_singles__ok(self):
        ...
        codelist1.add_attributes(CodelistAttributes(
            'Exposure Dosing Frequency per Interval', 'EXDOSFRQ', None, None, None, None), None)
        term.add_submission_value('TID', codelist1)

        codelist2 = Codelist('C78419')
        codelist2.add_attributes(CodelistAttributes(
            'Concomitant Medication Dosing Frequency per Interval', 'CMDOSFRQ', None, None, None, None), None)
    ...
    def test__fork_for_tsv_pair(self):
        ...
        # when
        new_term = term.fork_for_code_submission_value(
            'WIDTH', [tsv_pair], package)
        same_term = term.fork_for_code_submission_value(
            'WIDTH', [tsv_pair], package)
    ...
    def test__get_code_name_submission_value_pairs__i06_ok(self):
        ...
        codelist_C01.add_attributes(CodelistAttributes(
            'Codelist C01 Code', 'SM C01', None, None, None, None), None)

        codelist_C02 = Codelist('C02')
        term.add_submission_value('SM T01 Name', codelist_C02)
        codelist_C02.add_attributes(CodelistAttributes(
            'Codelist C01 Name', 'SM C02', None, None, None, None), None)
