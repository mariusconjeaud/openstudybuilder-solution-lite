...
[ -d "$FALLBACK_LICENSE_DIR" -o -z "$FALLBACK_LICENSE_DIR" ] || fatal "Fallback license directory not exists: $FALLBACK_LICENSE_DIR"
[ -r "$FALLBACK_LICENSE_DIR" -o -z "$FALLBACK_LICENSE_DIR" ] || fatal "Fallback license directory is not readable: $FALLBACK_LICENSE_DIR"
...
while IFS="=" read -a line; do
    ...
    [ -n "$license_files" -o -z "$FALLBACK_LICENSE_DIR" ] || {
